...
class TablesContraloria extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('elemento_comp', function(Blueprint $table){
            ...
            $table->integer('id_componente')->unsigned()->index();
            $table->timestamps();
        ...
        Schema::create('acredita_element', function(Blueprint $table){
            $table->integer('id_acredita')->unsigned()->index();
            $table->integer('id_elemento')->unsigned()->index();

            $table->foreign('id_acredita')->references('id')->on('acreditacion')
                ->onUpdate('cascade')->onDelete('cascade');
            $table->foreign('id_elemento')->references('id')->on('elemento_comp')
                ->onUpdate('cascade')->onDelete('cascade');

            $table->primary(['id_acredita', 'id_elemento']);
        });
        ...
        Schema::create('ptci_element', function(Blueprint $table){
            ...
            $table->primary(['id_element_comp', 'id_ptci']);
        });
        ...
        Schema::create('ptci_matriz', function(Blueprint $table){
            ...
            $table->primary(['id_ptci', 'id_matriz']);
        });
